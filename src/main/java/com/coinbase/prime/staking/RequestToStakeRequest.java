...
public class RequestToStakeRequest {
    @JsonIgnore
    ...
    public RequestToStakeRequest() {
    }

    public RequestToStakeRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public RequestToStakeRequest build() {
            return new RequestToStakeRequest(this);
        }
    }
}
