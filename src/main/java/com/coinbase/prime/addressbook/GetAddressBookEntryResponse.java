...
/**
 * Response containing a specific address book entry
 */
public class GetAddressBookEntryResponse {
    ...
    public GetAddressBookEntryResponse(AddressBookEntry addressBookEntry) {
