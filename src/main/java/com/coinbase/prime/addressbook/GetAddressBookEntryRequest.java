...
/**
 * Request to get a specific address book entry
 */
public class GetAddressBookEntryRequest {
    ...
    public GetAddressBookEntryRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetAddressBookEntryRequest build() throws CoinbaseClientException {
            this.validate();
            return new GetAddressBookEntryRequest(this);
        }
