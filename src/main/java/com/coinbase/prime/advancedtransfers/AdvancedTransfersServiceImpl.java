...
public class AdvancedTransfersServiceImpl extends CoinbaseServiceImpl implements AdvancedTransfersService {
    public AdvancedTransfersServiceImpl(CoinbasePrimeClient client) {
        super(client);
    }
