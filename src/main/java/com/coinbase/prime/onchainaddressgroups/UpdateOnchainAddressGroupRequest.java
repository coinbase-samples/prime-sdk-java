...
/**
 * Request for updating an onchain address group.
 */
public class UpdateOnchainAddressGroupRequest {
    private String portfolioId;
    
    @JsonProperty("address_group")
    private AddressGroup addressGroup;

    public UpdateOnchainAddressGroupRequest() {
    }

    private UpdateOnchainAddressGroupRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateOnchainAddressGroupRequest build() {
            return new UpdateOnchainAddressGroupRequest(this);
        }
    }
}