...
public class CreateOnchainTransactionEvmParams {
    ...
    public CreateOnchainTransactionEvmParams() {
    }

    public CreateOnchainTransactionEvmParams(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreateOnchainTransactionEvmParams build() {
            return new CreateOnchainTransactionEvmParams(this);
        }
    }
}