...
public class CoinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees {
  ...
  public CoinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees assetSymbol(String assetSymbol) {
  ...
  **/
  ...
  public CoinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees assetQuantityLowerBound(String assetQuantityLowerBound) {
  ...
  **/
  ...
  public CoinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees assetQuantityUpperBound(String assetQuantityUpperBound) {
  ...
  **/
  ...
  public CoinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees usdValueLowerBound(String usdValueLowerBound) {
  ...
  **/
  ...
  public CoinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees usdValueUpperBound(String usdValueUpperBound) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CoinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees coinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees = (CoinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees) o;
    return Objects.equals(this.assetSymbol, coinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees.assetSymbol) &&
        Objects.equals(this.assetQuantityLowerBound, coinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees.assetQuantityLowerBound) &&
        Objects.equals(this.assetQuantityUpperBound, coinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees.assetQuantityUpperBound) &&
        Objects.equals(this.usdValueLowerBound, coinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees.usdValueLowerBound) &&
        Objects.equals(this.usdValueUpperBound, coinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees.usdValueUpperBound);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoinbaseEngPrimeApiApiWeb3TransactionActivityMetadataFees {\n");
